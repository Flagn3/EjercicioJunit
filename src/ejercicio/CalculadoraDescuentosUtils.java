...
/**
 * Clase utilitaria para calcular el total con descuentos aplicados a una lista
 * de productos.
 */
public class CalculadoraDescuentosUtils {

	/**
	 * Calcula el precio total aplicando descuentos según la categoría, cantidad y
	 * si el cliente es VIP.
	 *
	 * @param productos    Lista de productos a procesar.
	 * @param esClienteVip Indica si el cliente tiene el beneficio de cliente VIP
	 *                     (descuento adicional del 5%).
	 * @return Total a pagar con los descuentos aplicados, redondeado a dos
	 *         decimales.
	...
	/**
	 * Determina el descuento base según la categoría del producto y la cantidad
	 * comprada.
	 *
